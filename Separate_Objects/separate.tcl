...
xilinx.com:hls:flap_detector:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: flap_detector_0, and set properties
  set flap_detector_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:flap_detector:1.0 flap_detector_0 ]
  ...
  connect_bd_intf_net -intf_net flap_detector_0_m_axi_gmem [get_bd_intf_pins axi_interconnect_1/S00_AXI] [get_bd_intf_pins flap_detector_0/m_axi_gmem]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets iop_pmoda_pmoda_gpio] [get_bd_intf_ports pmoda_gpio] [get_bd_intf_pins slice_pmoda_gpio/gpio]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_1_M04_AXI [get_bd_intf_pins flap_detector_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph_1/M04_AXI]
  ...
  connect_bd_net -net rst_ps7_0_fclk0_peripheral_aresetn [get_bd_pins audio_direct_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins btns_gpio/s_axi_aresetn] [get_bd_pins flap_detector_0/ap_rst_n] [get_bd_pins iop_arduino/s_axi_aresetn] [get_bd_pins iop_pmoda/s_axi_aresetn] [get_bd_pins iop_pmodb/s_axi_aresetn] [get_bd_pins leds_gpio/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph_1/M04_ARESETN] [get_bd_pins rgbleds_gpio/s_axi_aresetn] [get_bd_pins rst_ps7_0_fclk0/peripheral_aresetn] [get_bd_pins switches_gpio/s_axi_aresetn] [get_bd_pins system_interrupts/s_axi_aresetn] [get_bd_pins video/periph_resetn_clk100M]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces flap_detector_0/Data_m_axi_gmem] [get_bd_addr_segs ps7_0/S_AXI_HP3/HP3_DDR_LOWOCM] SEG_ps7_0_HP3_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x83C20000 [get_bd_addr_spaces ps7_0/Data] [get_bd_addr_segs flap_detector_0/s_axi_AXILiteS/Reg] SEG_flap_detector_0_Reg
