...
int main() {
	...
	//Hand input
	cv::Mat hand_src = cv::imread("/home/jr4918/720_cv2/hand.jpg", CV_LOAD_IMAGE_UNCHANGED);
	...
	//Output
	cv::Mat out_src = cv::imread("/home/jr4918/720_cv2/out.jpg", CV_LOAD_IMAGE_UNCHANGED);
